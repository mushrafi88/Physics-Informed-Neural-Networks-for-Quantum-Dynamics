...
class FourierFeatureNN(nn.Module):
    def __init__(self, input_dim=1, shared_units=128, output_dim=2, layers_per_path=2, scale=1.0, 
    ...
    def forward(self, x, t):
        ...
        output_1, output_2 = final_output.split(1, dim=-1)
...
def seq2seq_training(model_ur, model_ui, model_v, model_save_path, image_save_path, mse_cost_function, device, num_epochs, lr, num_samples, r, k, omega, gamma):
    ...
    for epoch in tqdm(range(num_epochs),
        ...
        total_loss = physics_loss_ur + physics_loss_ui + physics_loss_v  # + (1-lr)*(domain_loss_ur_t + domain_loss_ui_t + domain_loss_v_t)
